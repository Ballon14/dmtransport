      ...
      const items = [
        {
          ...
          quantity: booking.rentalUnits || booking.totalDays,
          name: `Sewa ${booking.vehicleName} (${booking.priceUnit || booking.totalDays + ' hari'})`.substring(0, 50),
        },
      ];
      // Add delivery cost as separate item if applicable
      if (booking.deliveryCost && booking.deliveryCost > 0) {
        items.push({
          id: 'delivery',
          price: booking.deliveryCost,
          quantity: 1,
