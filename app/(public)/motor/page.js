...
const infoItems = [
  ...
  { icon: "🪖", text: "Helm sudah termasuk (1 buah)" },
  { icon: "🪪", text: "Deposit: KTP/SIM + uang jaminan" },
  { icon: "🏍️", text: "Antar jemput area Purworejo" },
  { icon: "⛽", text: "Bensin full tank pertama" },
];
...
export default function MotorPage() {
  ...
  useEffect(() => {
    async function fetchMotors() {
      try {
        const res = await fetch('/api/vehicles?category=motor');
      ...
      <section style={styles.header}>
        ...
        <div style={styles.container}>
          <div style={styles.headerContent}>
            <span style={styles.headerBadge}>🏍️ Rental Motor</span>
            <h1 style={styles.title}>Sewa Motor di Purworejo</h1>
            <p style={styles.subtitle}>
              Pilih motor sesuai kebutuhan Anda. Semua motor dalam kondisi prima dan siap antar.
            </p>
            <div style={styles.headerStats}>
              <div style={styles.headerStat}>
                <span style={styles.headerStatNumber}>{motors.length}</span>
        ...
        <div style={styles.container}>
          <div style={styles.sectionHeader}>
            <div style={styles.sectionInfo}>
              <h2 style={styles.sectionTitle}>Pilihan Motor</h2>
              <p style={styles.sectionSubtitle}>Tersedia {availableCount} motor siap sewa</p>
            </div>
          ...
          {loading ? (
            ...
            <div style={styles.emptyState}>
              ...
              <p>Mohon maaf, saat ini belum ada motor yang tersedia.</p>
            </div>
          )}
        </div>
      </section>
          ...
          <div style={styles.infoBox}>
            <div style={styles.infoBoxHeader}>
              ...
              <div>
                ...
                <p style={styles.infoSubtitle}>Ketentuan dan syarat sewa motor</p>
              </div>
            </div>
...
const styles = {
  ...
  headerStatNumber: { display: "block", fontSize: "1.75rem", fontWeight: "800", color: "#a78bfa" },
